                        ...
                        <div class="slick-carousel" id="news">
                                ...
                                <article class="blognews">
                                    <a href="blogpost.html" class="mt5 mb15">
                                        <div class="item-img-wrap">
                                            <img src="../../public/assets/img/pic.jpg" class="img-fluid" alt="template">
                            ...
                            <div>
                                <article class="blognews">
                                    <a href="blogpost.html" class="mt5 mb15">
                                        <div class="item-img-wrap">
                                            <img src="../../public/assets/img/pic2.jpg" class="img-fluid" alt="template">
                                            <div class="item-img-overlay">
                                                <div class="news">
                                                    <span class="btn btn-transparent-sm"><i class="fa fa-plus"></i> Read more</span>
                                                </div>
                            ...
                            <div>
                                <article class="blognews">
                                    <a href="blogpost.html" class="mt5 mb15">
                                        <div class="item-img-wrap">
                                            <img src="../../public/assets/img/pic3.jpg" class="img-fluid" alt="template">
                                            <div class="item-img-overlay">
                                                <div class="news">
                                                    <span class="btn btn-transparent-sm"><i class="fa fa-plus"></i> Read more</span>
                                                </div>
